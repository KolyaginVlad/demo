...
public class AppController {
    ...
    @FXML
    private TableView<List<Integer>> bubbleTable;
    @FXML
    private Button btnBubble;

    @FXML
    private TableView<List<Integer>> selectTable;
    @FXML
    private Button btnSelect;

    @FXML
    private TableView<List<Integer>> insertTable;
    @FXML
    private Button btnInsert;

    @FXML
    private TableView<List<Integer>> shellTable;
    @FXML
    private Button btnShell;

    @FXML
    private TableView<List<Integer>> linearTable;
    @FXML
    ...
    @FXML
    private TableColumn<InfoAboutSort, Double> countCompare;
    @FXML
    private TableColumn<InfoAboutSort, Double> countSwap;
    @FXML
    private TableColumn<InfoAboutSort, Double> time;
    @FXML
    ...
    private void fillTable(TableView<List<Integer>> table, SortMethod method, int[] array) {
        ...
        for (int i = 0; i < allSteps.get(0).size(); i++) {
            ...
            int number = i;
            tc.setCellValueFactory(new Callback<CellDataFeatures<List<Integer>, Integer>, ObservableValue<Integer>>() {
